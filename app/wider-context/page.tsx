        ...
        <div className="md:col-span-2">
          <Tabs defaultValue="overview">
            ...
            <TabsContent value="overview" className="p-4 border rounded-md mt-2">
              ...
              <p className="mb-4">
                This section demonstrates my understanding of and engagement with legislation, policies, and standards.
                It covers:
              </p>
            ...
            <TabsContent value="evidence" className="space-y-4 p-4 border rounded-md mt-2">
              <div className="space-y-4">
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-sm text-muted-foreground mb-4">
                      Documentation of my role in developing and implementing an institutional accessibility policy for
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-sm text-muted-foreground mb-4">
                      A data protection impact assessment I conducted for a new learning analytics system, demonstrating
            ...
            <TabsContent value="reflection" className="p-4 border rounded-md mt-2">
              ...
              <p className="mb-4">
                I've found that staying informed about emerging policies and standards is essential, as is engaging with
