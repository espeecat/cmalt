        ...
        <div className="md:col-span-2">
          <Tabs defaultValue="overview">
            ...
            <TabsContent value="overview" className="p-4 border rounded-md mt-2">
              ...
              <p className="mb-4">
                This section demonstrates my understanding of the constraints and benefits of different technologies in
            ...
            <TabsContent value="reflection" className="p-4 border rounded-md mt-2">
              ...
              <p className="mb-4">
                My approach to operational issues in learning technology has evolved significantly over my career. I've
                learned that successful technology implementation requires not just technical knowledge, but also a deep
              ...
              <p className="mb-4">
                ...
                offer exciting possibilities, they must be thoroughly tested and supported to ensure they enhance rather
